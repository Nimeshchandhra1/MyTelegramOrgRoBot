...
class Config(object):
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "appidhashbot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Appidhash")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Appidhashbot")
    APP_DESCRIPTION = os.environ.get("APP_DESCRIPTION", "created using https://telegram.dog/Appidhashbot")
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @Trustedfull")
